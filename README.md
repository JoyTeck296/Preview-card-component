...
- **Free icon images** stored in the `/image` folder

The goal of this project is to replicate a clean design, proper layout structuring, and responsive web design.